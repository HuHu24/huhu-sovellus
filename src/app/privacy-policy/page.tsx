    ...
    <>
      <div className="inline-flex h-[68px] w-full flex-col items-start justify-start gap-2.5 bg-oslo p-2.5">
        <div className="inline-flex items-center justify-between self-stretch">
          ...
          <div className="z-10 font-opensauce text-2xl font-normal text-ateena">
            Tietosuojaseloste
          </div>
        </div>
      </div>
      <div className="p-3">
        ...
        <br />
        Lounais-Suomen Partiopiiri ry (2197948-1)
        <br />
        Itsenäisyydenkatu 44
        <br />
        28130 Pori
        <br />
        partiotoimisto.lsp@partio.fi
        <br />
        <br />
        ...
        HuHu-sovellukseen. Alla mainituista henkilötietoryhmistä kerätään
        kulloinkin tarpeelliset tiedot. Osa tiedoista voi olla vapaaehtoisia.
        <br />
        <ul className="ml-7 list-disc">
          <li>perustiedot, kuten nimi</li>
          <li>yhteystiedot, kuten sähköpostiosoite</li>
          <li>
        ...
        kuten HuHu-sovelluksen toimittamiseen. Henkilötietojen käsittely
        perustuu Rekisteröidyn ja Rekisterinpitäjän väliseen sopimukseen
        HuHu-sovelluksen toimittamisesta.
        <br />
        <br />
        ...
        HuHu-sovelluksen käyttökokemuksen parantamiseksi, sekä käytön
        seuraamiseksi ja helpottamiseksi käytämme evästeitä (cookies). Evästeet
        mahdollistavat lyhyiden tekstimuotoisten tietojen tallentamisen
        käyttäjän selaimeen myöhempää käyttöä varten. <br />
        <br />
        <strong> Sijaintitietojen kerääminen ja käyttö</strong>
        <br />
        Rekisterinpitäjä tai Tietojen käsittelijä eivät pääsääntöisesti kerää
        ...
        enimmillään 3 kuukauden ajan Rekisteröidystä. Voimassa oleva kirjanpito-
