...
export default async function AdminFrontpage(request: NextRequest) {
  ...
  const data = await response.json() as { claims: { admin: boolean, subcamp: boolean, safety: boolean } }
  ...
  return <>
    <div className="relative h-full w-full overflow-hidden bg-helsinki">
      ...
      <div className="-20 -mt-3 flex h-full w-full flex-col gap-4 overflow-auto p-3">
        <div className="z-20 w-full bg-oslo rounded-[20px] p-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          {data.claims.safety || data.claims.admin ?
            <Link href={"/admin/chat"}>
              <div
                className="bg-soul aspect-square rounded-[20px] flex flex-col place-content-center place-items-center">
              <span
            ...
            {data.claims.subcamp || data.claims.admin ?
              <>
                <Link href={"/admin/releases"}>
                  <div
                    className="bg-tokio text-helsinki aspect-square rounded-[20px] flex flex-col place-content-center place-items-center">
              <span
                className="material-symbols-outlined text-9xl">
                full_coverage
              </span>
                ...
                <Link href={"/admin/notifications"}>
                  <div
                    className="bg-oslo aspect-square rounded-[20px] flex flex-col place-content-center place-items-center">
              <span
                className="material-symbols-outlined text-9xl">
          ...
          {data.claims.admin ?
            <Link href={"/admin/access"}>
              <div
                className="bg-buenos_aires text-helsinki aspect-square rounded-[20px] flex flex-col place-content-center place-items-center">
                <span
                  className="material-symbols-outlined text-9xl">
                lock
                </span>
