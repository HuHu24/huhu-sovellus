        ...
        <>
            ...
            <div className="flex h-screen w-full place-content-center place-items-center text-center font-poppins">
                ...
                <div
                    ...
                    <input
                        onChange={(event) => handleOptionChange("title", event.target.value)}
                        className="w-[80%] rounded-lg bg-barcelona p-1 text-xl text-helsinki"
                        placeholder="Otiskko..."
                    />
                    <input
                        onChange={(event) => handleOptionChange("message", event.target.value)}
                        className="w-[80%] rounded-lg bg-barcelona p-1 text-xl text-helsinki"
                        placeholder="Sisältö..."
                    /> <select
                    onChange={(event) => handleOptionChange("topic", event.target.value)}
                    className=" w-[80%] rounded-lg bg-barcelona p-1 text-xl text-helsinki">
                    ...
                    <button
                        ...
                        className="rounded-lg bg-soul p-1 px-5 text-xl w-[80%] h-[70px]"
                    >
                        Lähetä
                    </button>
                </div>
