...
export default function Home() {
    return (
        <div className="relative overflow-hidden h-full w-screen bg-helsinki">
            <div
            ...
            <div className="absolute w-screen flex justify-center gap-3">
                <Sort title="Alaleiri" options={["Ananas", "Tomaatti", "Pasteija", "a", "jaahaas"]}></Sort>
                <Sort title="julkaisija" options={["Julkaisupäivä", "Julkaisija", "Kriittisyys"]}></Sort>
                <Sort title="Kriittiisyys" options={["Kriittinen", "Jotain", "Jotain2"]}></Sort>
            </div>
