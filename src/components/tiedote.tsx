  ...
  return (
    <Link href={"/"} className="z-10">
      <div className="mr-4 flex flex-col">
        ...
        <div className="w-[180px] whitespace-normal font-poppins font-normal text-ateena text-shadow shadow-helsinki">
          {tiedot.otsikko}
        </div>
        <div className="h-[76px] w-full overflow-hidden whitespace-normal font-opensauce text-sm font-normal text-ateena text-shadow shadow-helsinki">
